...
public class LocationDB implements State {
	...
	// public List<List<VehicleAlarmBean>>
	// bulkGetLocations(List<ObjectModelOfKafka> omokList) {
	// List<List<VehicleAlarmBean>> alarmList = new ArrayList<>();
	// for (ObjectModelOfKafka omok : omokList) {
	// try {
	// VehicleAlarmStatus vehicleAlarm = new
	// VehicleAlarmStatus(omok,this.statusData);
